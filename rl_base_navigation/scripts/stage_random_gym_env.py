...
class StageEnv(Node, gym.Env):
    ...
    def start_stage(self):
        ...
        req = SetBool.Request()
        req.data = True
        self.rerandom_obj_vel_client.call_async(req)
    ...
    def _compute_reward(self):
        ...
        if min_dist < 0.61:  # Collision detected
    ...
    def _check_done(self):
        ...
        if min_dist < 0.61 or self.distance_to_goal[0] < 0.2 or self.num_steps > TERMINATION_STEPS: 
            return True
